...
import com.callor.book.persistance.UserRoleDao;
...
public class UserServiceImplV1 implements UserService {
    ...
    public UserVO join(UserVO userVO) {
        ...
        /*
        테이블에 데이터가 없으면 count() 연산은 당연히 0을 보여준다
        그러면 userCount == 0 의 놀리식도 문제가 없어 보인다.
        ...
        if (userCount < 1){
            ...
            // boot 에서는 필수적으로 체크하는 항목이므로 설정을 해주어야 한다
